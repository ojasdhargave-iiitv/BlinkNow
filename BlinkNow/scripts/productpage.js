...
function showProduct(productId) {
    ...
    `;
    productContent.querySelector('.add-to-cart-btn').addEventListener('click', function() {
...
function displaySortedProducts(productsData, sortOrder) {
    ...
    sortedProducts.forEach(product => {
        ...
        productCard.querySelector('.see-all-add-to-cart-btn').addEventListener('click', function(e) {
